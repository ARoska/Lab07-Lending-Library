...
namespace LendingLibrary
{
    public class Program
    {
        ...
        static void LibraryInit()
        {
            ...
            //Library<Book> library = new Library<Book>
            //{
            //    new Book("Ender's Game", "Orson Scott Card", "SciFi", 1985, true),
            //    new Book("Speaker for the Dead", "Orson Scott Card", "SciFi", 1986, false),
            //    new Book("Xenocide", "Orson Scott Card", "SciFi", 1991,  true),
            //    new Book("Children of the Mind", "Orson Scott Card", "SciFi", 1996, true),
            ...
            //    new Book("Shadow Puppets", "Orson Scott Card", "SciFi", 2002, true),
